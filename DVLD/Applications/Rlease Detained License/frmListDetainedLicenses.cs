...
namespace DVLD.Applications.Rlease_Detained_License
{
    public partial class frmListDetainedLicenses : Form
    {
        ...
        private void frmListDetainedLicenses_Load(object sender, EventArgs e)
        {
            ...
            lblRecordsNo.Text = "# Records :  "+ dgvDetainedLicenses.Rows.Count.ToString();
        ...
        private void txtFilterValue_TextChanged(object sender, EventArgs e)
        {
            ...
            lblRecordsNo.Text = "# Records :  " + _dtDetainedLicenses.Rows.Count.ToString();
        ...
        private void ShowPersonInfotoolStripMenuItem2_Click(object sender, EventArgs e)
        {
        ...
        {
            ReleaseLicensetoolStripMenuItem1.Enabled = !(bool)dgvDetainedLicenses.CurrentRow.Cells[3].Value;
        }
    }
}
